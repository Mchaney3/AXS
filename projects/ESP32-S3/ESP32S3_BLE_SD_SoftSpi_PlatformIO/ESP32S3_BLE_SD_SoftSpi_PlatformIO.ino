...
void display_Running_Sketch (void)
{
  ...
  String bin_path = __FILE__;
  int slash_idx = bin_path.lastIndexOf('/');
  String bin_name = bin_path.substring(slash_idx+1);
  int dot_idx = bin_name.lastIndexOf('.');
  String app_name = bin_name.substring(0, dot_idx);
  Serial.print("\nCPU initialized at " + String(cpuSpeed) + "MHz");  Serial.print("\nBooting ");
  Serial.print(app_name);  Serial.print("\nCompiled on: ");  Serial.print(__DATE__);
  Serial.print(", ");  Serial.print(__TIME__);  Serial.print("\nESP-IDF SDK: "); 
  Serial.println(ESP.getSdkVersion());  Serial.println();
}
