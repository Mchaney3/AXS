...
#define USE_SSL     false
  ...
  #ifndef LED_BUILTIN
    #define LED_BUILTIN       -1         // Pin D2 mapped to pin GPIO2/ADC12 of ESP32, control on-board LED
  #endif
  ...
  // If local server
  #if USE_LOCAL_SERVER
    char blynk_server[]   = "mowbotiot.axstechnology.com";
  #endif
