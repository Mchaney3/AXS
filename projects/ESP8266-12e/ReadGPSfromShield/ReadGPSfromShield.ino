...
#define FONA_RST 5
#define FONA_TX 2 // ESP32 hardware serial RX2 (GPIO16)
#define FONA_RX 8 // ESP32 hardware serial TX2 (GPIO17)
...
void setup() {
  ...
  fonaSS.begin(115200, SERIAL_8N1); // baud rate, protocol, ESP32 RX pin, ESP32 TX pin

  Serial.println(F("Configuring to 9600 baud"));
  fonaSS.println("AT+IPR=9600"); // Set baud rate
  delay(100); // Short pause to let the command run
  fonaSS.begin(9600, SERIAL_8N1); // Switch to 9600
